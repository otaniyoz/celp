...
OBJ=quantize_image.o edge_image.o image_opencv.o load_image.o process_image.o args.o filter_image.o resize_image.o harris_image.o matrix.o panorama_image.o list.o data.o
EXOBJ=main.o
